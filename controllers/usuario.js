...
const putUsuario = async(req, res) => {
    const { nombre, apellido, tipo_documento, numero_documento, telefono, correo, ciudad, nombre_usuario, password, rol, estado,  } = req.body //Desesctructurar
    let mensaje = ''
    try {
        const usuario = await Usuario.findOneAndUpdate({nombre: nombre},
        {apellido:apellido, tipo_documento:tipo_documento, numero_documento:numero_documento, telefono:telefono, correo:correo, ciudad:ciudad, nombre_usuario:nombre_usuario, password:password, rol:rol, estado:estado,})
